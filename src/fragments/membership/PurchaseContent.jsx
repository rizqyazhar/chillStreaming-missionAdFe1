          ...
          <form className='w-full lg:w-2/4 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='w-full lg:w-1/2 flex flex-col gap-2 text-light-secondary font-normal text-xs lg:text-base'>
                ...
                <p className='flex justify-between'>
                  Biaya Admin{" "}
                  <span className='text-light-primary'>Rp3.000</span>
                </p>
            ...
            <button
              type='button'
              onClick={handleClick}
              className='place-self-start bg-primary-400 rounded-full px-4 py-2 text-sm lg:text-base font-bold cursor-pointer'>
              Bayar
            </button>
          </form>
        </div>
